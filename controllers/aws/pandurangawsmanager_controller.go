...
// PandurangAWSManagerReconciler reconciles a PandurangAWSManager object
type PandurangAWSManagerReconciler struct {
	client.Client
	Scheme *runtime.Scheme
}

//+kubebuilder:rbac:groups=aws.pandurang.com,resources=pandurangawsmanagers,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=aws.pandurang.com,resources=pandurangawsmanagers/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=aws.pandurang.com,resources=pandurangawsmanagers/finalizers,verbs=update
...
// the PandurangAWSManager object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.13.0/pkg/reconcile
func (r *PandurangAWSManagerReconciler) Reconcile(ctx context.Context, req ctrl.Request) (ctrl.Result, error) {
	...
	awsManager := &awsv1.PandurangAWSManager{}
...
// Deployment Spec
func (r *PandurangAWSManagerReconciler) DeploymentForAWSManager(ctx context.Context, req ctrl.Request, awsManager *awsv1.PandurangAWSManager) *appsv1.Deployment {
...
func (r *PandurangAWSManagerReconciler) SetupWithManager(mgr ctrl.Manager) error {
	return ctrl.NewControllerManagedBy(mgr).
		For(&awsv1.PandurangAWSManager{}).
